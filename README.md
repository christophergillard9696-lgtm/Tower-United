...
- When setting up the keyword & review scraper (pulling over 14,000 reviews, snippit below), useless keywords would still come in despite using a joiner word stop list library, requiring me to manually update the list and re-run the programme. (I am seeking a potential fix)
